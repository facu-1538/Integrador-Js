...
export const handleRenderListItems = (productsIn) => {
  const burgers = productsIn.filter((el) => el.categoria === "Tacos");
  const drinks = productsIn.filter((el) => el.categoria === "Gaseosas");
  const potatos = productsIn.filter((el) => el.categoria === "Nachos");
  ...
  appContainer.innerHTML = `
    ${renderProductGroup(burgers, "Tacos")}
    ${renderProductGroup(potatos, "Nachos")}
